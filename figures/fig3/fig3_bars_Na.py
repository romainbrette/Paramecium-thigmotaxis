...
filename_Na = os.path.join(data_path, 'Dynamics/Log cells in Ca-K-Na solution/count2.tsv')
filename_control = os.path.join(data_path, 'Dynamics/Log cells in Ca-K-Na solution/count.tsv')
